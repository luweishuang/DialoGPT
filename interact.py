...
def run_model():
    ...
    parser.add_argument('--model_name_or_path', type=str, default='models/large', help='pretrained model name or path to local checkpoint')
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--load_checkpoint", '-c', type=str, default='models/large/large_fs.pkl')
...
if __name__ == '__main__':
    ...
    target_folder = download_model(model_size='large', dataset='multiref', from_scratch=False)
    logger.info('Done!\n')
